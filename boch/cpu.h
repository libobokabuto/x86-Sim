...
#define BX_INSTR_FAR_BRANCH_ORIGIN()  //1319
   ...
   // prototypes for CPU instructions...
    ...
    BX_SMF void FISTTP16(bxInstruction_c*) BX_CPP_AttrRegparmN(1);
...
#undef FSCALE            // <sys/param.h> is #included on Mac OS X from bochs.h
  ...
  // RAO-INT
    ...
    BX_SMF void VCOMISBF16_VshWshR(bxInstruction_c*) BX_CPP_AttrRegparmN(1);
    BX_SMF void VGETMANTPBF16_MASK_VphWphIbR(bxInstruction_c*) BX_CPP_AttrRegparmN(1);
    BX_SMF void VREDUCEBF16_MASK_VphWphIbR(bxInstruction_c*) BX_CPP_AttrRegparmN(1);
    BX_SMF void VRNDSCALEBF16_MASK_VphWphIbR(bxInstruction_c*) BX_CPP_AttrRegparmN(1);
    ...
    BX_SMF void VMINMAXBF16_MASK_VphHphWphIbR(bxInstruction_c*) BX_CPP_AttrRegparmN(1);
    ...
    BX_SMF void VCVTPH2BF8_Vf8HdqWphR(bxInstruction_c*) BX_CPP_AttrRegparmN(1);
    BX_SMF void VCVT2PH2BF8_Vf8HdqWphR(bxInstruction_c*) BX_CPP_AttrRegparmN(1);
    BX_SMF void VCVTBIASPH2BF8_Vf8HdqWphR(bxInstruction_c*) BX_CPP_AttrRegparmN(1);
    BX_SMF void VCVTPH2HF8_Vf8HdqWphR(bxInstruction_c*) BX_CPP_AttrRegparmN(1);
    BX_SMF void VCVT2PH2HF8_Vf8HdqWphR(bxInstruction_c*) BX_CPP_AttrRegparmN(1);
    BX_SMF void VCVTBIASPH2HF8_Vf8HdqWphR(bxInstruction_c*) BX_CPP_AttrRegparmN(1);

    // AVX10.2 convert to int8 with saturation
    BX_SMF void VCVTBF162IBS_V8bWphR(bxInstruction_c*) BX_CPP_AttrRegparmN(1);
    BX_SMF void VCVTBF162IUBS_V8bWphR(bxInstruction_c*) BX_CPP_AttrRegparmN(1);
    BX_SMF void VCVTBF162IBS_MASK_V8bWphR(bxInstruction_c*) BX_CPP_AttrRegparmN(1);
    BX_SMF void VCVTBF162IUBS_MASK_V8bWphR(bxInstruction_c*) BX_CPP_AttrRegparmN(1);
    BX_SMF void VCVTTBF162IBS_V8bWphR(bxInstruction_c*) BX_CPP_AttrRegparmN(1);
    BX_SMF void VCVTTBF162IUBS_V8bWphR(bxInstruction_c*) BX_CPP_AttrRegparmN(1);
    BX_SMF void VCVTTBF162IBS_MASK_V8bWphR(bxInstruction_c*) BX_CPP_AttrRegparmN(1);
    BX_SMF void VCVTTBF162IUBS_MASK_V8bWphR(bxInstruction_c*) BX_CPP_AttrRegparmN(1);
...
#endif
    BX_SMF bool handleAsyncEvent(void); //4483
    BX_SMF bool handleWaitForEvent(void); //4484
    BX_SMF void HandleExtInterrupt(void); //4485
    BX_SMF Bit8u interrupt_acknowledge(void);//4486
    ...
    BX_SMF Bit8u read_linear_byte(unsigned seg, bx_address offset) BX_CPP_AttrRegparmN(2); //4517
    ...
    BX_SMF bool shadow_stack_atomic_set_busy(bx_address offset, unsigned curr_pl) BX_CPP_AttrRegparmN(2); //4652
    ...
    BX_SMF Bit8u  system_read_byte(bx_address laddr) BX_CPP_AttrRegparmN(1); //4659
    ...
    BX_SMF Bit16u read_physical_word(bx_phy_address paddr, BxMemtype memtype, AccessReason reason); //4706
    ...
    BX_SMF void protected_mode_int(Bit8u vector, bool soft_int, bool push_error, Bit16u error_code);//4765
#if BX_SUPPORT_X86_64
    ...
    BX_SMF bool SetCR0(bxInstruction_c* i, bx_address val);//4776
    BX_SMF bool check_CR0(bx_address val) BX_CPP_AttrRegparmN(1);//4777
    BX_SMF bool SetCR3(bx_address val) BX_CPP_AttrRegparmN(1); //4778
#if BX_CPU_LEVEL >= 5
...
#endif
#if BX_CPU_LEVEL >= 5
    BX_SMF bool SetEFER(bx_address val) BX_CPP_AttrRegparmN(1);//4791
    BX_SMF Bit32u get_efer_allow_mask(void);  //4792
#endif
    BX_SMF bx_address read_CR0(void);//4795
    #if BX_CPU_LEVEL >= 5
  BX_SMF bx_address read_CR4(void);
...
#if BX_CPU_LEVEL >= 5
    BX_SMF bool rdmsr(Bit32u index, Bit64u* val_64) BX_CPP_AttrRegparmN(2);//4851
...
#if BX_SUPPORT_X86_64
    BX_SMF void long_iret(bxInstruction_c*) BX_CPP_AttrRegparmN(1);//4886
#endif
#if BX_SUPPORT_CET
    BX_SMF void shadow_stack_switch(bx_address new_SSP) BX_CPP_AttrRegparmN(1);
    BX_SMF void call_far_shadow_stack_push(Bit16u cs, bx_address lip, bx_address old_ssp) BX_CPP_AttrRegparmN(3); //4889
    BX_SMF bx_address shadow_stack_restore(Bit16u raw_cs_selector, const bx_descriptor_t& cs_descriptor, bx_address return_rip) BX_CPP_AttrRegparmN(3);//4891
#endif
    BX_SMF void validate_seg_reg(unsigned seg);
    BX_SMF void validate_seg_regs(void);//4894
    BX_SMF void stack_return_to_v86(Bit32u new_eip, Bit32u raw_cs_selector, Bit32u flags32);//4895
    BX_SMF void iret16_stack_return_from_v86(bxInstruction_c*);//4896
    BX_SMF bool v86_redirect_interrupt(Bit8u vector); //4897
    BX_SMF void iret32_stack_return_from_v86(bxInstruction_c*);//4898
    BX_SMF void init_v8086_mode(void);//4899
    BX_SMF void task_switch_load_selector(bx_segment_reg_t* seg,
        bx_selector_t* selector, Bit16u raw_selector, Bit8u cs_rpl);//4900
    BX_SMF void task_switch(bxInstruction_c* i, bx_selector_t* selector, bx_descriptor_t* descriptor,
        unsigned source, Bit32u dword1, Bit32u dword2, bool push_error = 0, Bit32u error_code = 0);//4902
    BX_SMF void get_SS_ESP_from_TSS(unsigned pl, Bit16u* ss, Bit32u* esp); //4903
#if BX_SUPPORT_X86_64
    BX_SMF Bit64u get_RSP_from_TSS(unsigned pl); //4905
#endif
    BX_SMF void write_flags(Bit16u flags, bool change_IOPL, bool change_IF) BX_CPP_AttrRegparmN(3);//4908
    BX_SMF void writeEFlags(Bit32u eflags, Bit32u changeMask) BX_CPP_AttrRegparmN(2);//4908
    ...
    BX_SMF void    check_cs(bx_descriptor_t* descriptor, Bit16u cs_raw, Bit8u check_rpl, Bit8u check_cpl);//4921
    BX_SMF void    load_cs(bx_selector_t* selector, bx_descriptor_t* descriptor, Bit8u cpl) BX_CPP_AttrRegparmN(3); //4923
    BX_SMF void    load_ss(bx_selector_t* selector, bx_descriptor_t* descriptor, Bit8u cpl) BX_CPP_AttrRegparmN(3); //4924
    ...
    BX_SMF bool fetch_raw_descriptor2(const bx_selector_t* selector,
        Bit32u* dword1, Bit32u* dword2) BX_CPP_AttrRegparmN(3);//4929
...
#endif
    BX_SMF Bit32u  code_breakpoint_match(bx_address laddr); //4980
    ...
    BX_SMF void VMwrite16(unsigned encoding, Bit16u val_16) BX_CPP_AttrRegparmN(2); //5230
    ...
    BX_SMF Bit32u VMXReadRevisionID(bx_phy_address pAddr);//5249
    ...
    BX_SMF void VMX_TPR_Virtualization(void);//5287
    BX_SMF bool Virtualize_X2APIC_Write(unsigned msr, Bit64u val_64); //5288
    BX_SMF void VMX_Virtual_Apic_Access_Trap(void);//5289
#if BX_SUPPORT_VMX >= 2
    BX_SMF bool VMX_Posted_Interrupt_Processing(Bit8u vector);//5291
    BX_SMF void vapic_set_vector(unsigned apic_arrbase, Bit8u vector); //5292
    BX_SMF Bit8u vapic_clear_and_find_highest_priority_int(unsigned apic_arrbase, Bit8u vector); //5293
    BX_SMF void VMX_Write_VICR(void);
    BX_SMF void VMX_Write_VICR_HI(void);
    BX_SMF void VMX_PPR_Virtualization(void);  //5296
    BX_SMF void VMX_EOI_Virtualization(void); //5297
    BX_SMF void VMX_Self_IPI_Virtualization(Bit8u vector);
    BX_SMF void VMX_Evaluate_Pending_Virtual_Interrupts(void); //5299
    BX_SMF void VMX_Deliver_Virtual_Interrupt(void);//5300
...
#endif
#endif//5313
    BX_SMF void VMexit_Instruction(bxInstruction_c* i, Bit32u reason, bool rw = BX_READ) BX_CPP_AttrRegparmN(3);//5315
    ...
    BX_SMF bool VMexit_CLTS(void);//5323
    ...
    BX_SMF void VMexit_CR3_Write(bxInstruction_c* i, bx_address) BX_CPP_AttrRegparmN(2);//5329
...
#define RMAddr(i)  (BX_CPU_THIS_PTR address_xlation.rm_addr)//5399
