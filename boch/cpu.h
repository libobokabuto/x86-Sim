...
#define BX_INSTR_FAR_BRANCH_ORIGIN()
   ...
   // prototypes for CPU instructions...
    ...
    BX_SMF void OUT_IbAL(bxInstruction_c*) BX_CPP_AttrRegparmN(1) { gao_no(__LINE__, __func__); }
    ...
    BX_SMF void CMP_EbIbR(bxInstruction_c*) BX_CPP_AttrRegparmN(1) { gao_no(__LINE__, __func__); }
...
#undef FSCALE            // <sys/param.h> is #included on Mac OS X from bochs.h
  ...
  // RAO-INT
    ...
    BX_SMF void MOV_EbIbR(bxInstruction_c*) BX_CPP_AttrRegparmN(1) { gao_no(__LINE__, __func__); }
